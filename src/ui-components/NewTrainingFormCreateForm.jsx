...
import { createNewTrainingForm } from "../../mutations";
const client = generateClient();
export default function NewTrainingFormCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createNewTrainingForm.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "NewTrainingFormCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
